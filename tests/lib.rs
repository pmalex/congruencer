...
use congruencer::{
    act::fixed::Act, congruence::Congruence, lattice::Lattice, partition::Partition,
};
...
mod acts_over_left_zero_semigroup {
    ...
    pub static P_A1: [u16; 3] = [0b0011, 0b1000, 0b0100]; // (a1)
    pub static P_A12: [u16; 2] = [0b0111, 0b1000]; // (a12)
    pub static P_A13: [u16; 2] = [0b1011, 0b0100]; // (a13)
    pub static P_A1_23: [u16; 2] = [0b0011, 0b1100]; // (a1)(23)
    pub static P_123: [u16; 2] = [0b1110, 0b0001]; // (123)
    pub static P_12: [u16; 3] = [0b0110, 0b1000, 0b0001]; // (12)
    pub static P_13: [u16; 3] = [0b1010, 0b0100, 0b0001]; // (13)
    pub static P_23: [u16; 3] = [0b1100, 0b0010, 0b0001]; // (23)
    pub static P_DELTA: [u16; 4] = [0b1000, 0b0100, 0b0010, 0b0001]; // Δ
...
fn lattice_of_congruences_1() {
    ...
    let act = Act::new(acts_over_left_zero_semigroup::ACT_1);
...
fn lattice_of_congruences_2() {
    ...
    let act = Act::new(acts_over_left_zero_semigroup::ACT_2);
